            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="../solicitud/index.php">Registro de solicitud</a>
                        </li>
                        <li class="nav-item">
            ...
            ?>     
                ...
                <div class="login2"class="container mt-2 ml-2" >
                    ...
                    <div class="form-group row">
                        ...
                        <input type="submit" class="btn btn-success" value="Registrar" action="index.php" >
